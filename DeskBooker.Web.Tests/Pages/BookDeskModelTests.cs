...
namespace DeskBooker.Web.Pages
{
  public class BookDeskModelTests
  {
        ...
        public void ShouldCallBookDeskMethodOfProcessorIfModelIsValid(int expectedBookDeskCalls, bool isModelValid)
        {
            ...
            if (!isModelValid)
            {
                _bookDeskModel.ModelState.AddModelError("Key", "An Error Message");
            }
        ...
        public void ShouldReturnExpectedActualResult(Type expectedActionResultType, bool isModelValid, DeskBookingResultCode? deskBookingResultCode)
        {
            // Arrange
            if (!isModelValid)
            {
        ...
        public void ShouldRedirectToBookDeskConfirmationPage()
        {
            // Arrange
            _deskBookingResult.Code = DeskBookingResultCode.Success;
            _deskBookingResult.DeskBookingId = 1;
            _deskBookingResult.FirstName = "Ljourn";
            _deskBookingResult.Date = new DateTime(2020, 2, 12);
